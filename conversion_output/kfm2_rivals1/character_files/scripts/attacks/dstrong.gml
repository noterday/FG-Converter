...
set_window_value(AT_DSTRONG, 7, AG_WINDOW_LENGTH, 5);
...
set_hitbox_value(AT_DSTRONG, 1, HG_WIDTH, -22);
set_hitbox_value(AT_DSTRONG, 1, HG_HEIGHT, -15);
set_hitbox_value(AT_DSTRONG, 1, HG_PRIORITY, 1);
set_hitbox_value(AT_DSTRONG, 1, HG_DAMAGE, 1);
set_hitbox_value(AT_DSTRONG, 1, HG_ANGLE, 1);
...
set_hitbox_value(AT_DSTRONG, 2, HG_WIDTH, 18);
set_hitbox_value(AT_DSTRONG, 2, HG_HEIGHT, 13);
set_hitbox_value(AT_DSTRONG, 2, HG_PRIORITY, 1);
set_hitbox_value(AT_DSTRONG, 2, HG_DAMAGE, 1);
set_hitbox_value(AT_DSTRONG, 2, HG_ANGLE, 1);
...
set_hitbox_value(AT_DSTRONG, 3, HG_HITBOX_Y, -4);
set_hitbox_value(AT_DSTRONG, 3, HG_WIDTH, -18);
set_hitbox_value(AT_DSTRONG, 3, HG_HEIGHT, -11);
set_hitbox_value(AT_DSTRONG, 3, HG_PRIORITY, 1);
set_hitbox_value(AT_DSTRONG, 3, HG_DAMAGE, 1);
set_hitbox_value(AT_DSTRONG, 3, HG_ANGLE, 1);
