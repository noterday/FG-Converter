...
set_window_value(AT_FSPECIAL, 9, AG_WINDOW_LENGTH, 2);
...
set_hitbox_value(AT_FSPECIAL, 1, HG_HEIGHT, 17);
set_hitbox_value(AT_FSPECIAL, 1, HG_PRIORITY, 1);
set_hitbox_value(AT_FSPECIAL, 1, HG_DAMAGE, 1);
set_hitbox_value(AT_FSPECIAL, 1, HG_ANGLE, 1);
...
set_hitbox_value(AT_FSPECIAL, 2, HG_HITBOX_Y, -61);
set_hitbox_value(AT_FSPECIAL, 2, HG_WIDTH, 37);
...
set_hitbox_value(AT_FSPECIAL, 2, HG_ANGLE, 1);
