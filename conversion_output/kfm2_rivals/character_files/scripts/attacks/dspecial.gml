...
set_hitbox_value(AT_DSPECIAL, 2, HG_HITBOX_Y, -96);
set_hitbox_value(AT_DSPECIAL, 2, HG_WIDTH, 25);
set_hitbox_value(AT_DSPECIAL, 2, HG_HEIGHT, -71);
set_hitbox_value(AT_DSPECIAL, 2, HG_PRIORITY, 1);
set_hitbox_value(AT_DSPECIAL, 2, HG_DAMAGE, 1);
set_hitbox_value(AT_DSPECIAL, 2, HG_ANGLE, 1);
...
set_hitbox_value(AT_DSPECIAL, 3, HG_HITBOX_X, 37);
set_hitbox_value(AT_DSPECIAL, 3, HG_HITBOX_Y, -112);
set_hitbox_value(AT_DSPECIAL, 3, HG_WIDTH, 14);
