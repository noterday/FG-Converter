...
set_hitbox_value(AT_FTILT, 1, HG_HEIGHT, 17);
set_hitbox_value(AT_FTILT, 1, HG_PRIORITY, 1);
set_hitbox_value(AT_FTILT, 1, HG_DAMAGE, 1);
set_hitbox_value(AT_FTILT, 1, HG_ANGLE, 1);
...
set_hitbox_value(AT_FTILT, 3, HG_HITBOX_X, 61);
set_hitbox_value(AT_FTILT, 3, HG_HITBOX_Y, -28);
set_hitbox_value(AT_FTILT, 3, HG_WIDTH, -16);
set_hitbox_value(AT_FTILT, 3, HG_HEIGHT, 11);
set_hitbox_value(AT_FTILT, 3, HG_PRIORITY, 1);
set_hitbox_value(AT_FTILT, 3, HG_DAMAGE, 1);
set_hitbox_value(AT_FTILT, 3, HG_ANGLE, 1);
