...
set_hitbox_value(AT_DTILT, 1, HG_ANGLE, 1);
...
set_hitbox_value(AT_DTILT, 2, HG_HEIGHT, 9);
set_hitbox_value(AT_DTILT, 2, HG_PRIORITY, 1);
set_hitbox_value(AT_DTILT, 2, HG_DAMAGE, 1);
set_hitbox_value(AT_DTILT, 2, HG_ANGLE, 1);
set_hitbox_value(AT_DTILT, 2, HG_BASE_KNOCKBACK, 1);
...
set_hitbox_value(AT_DTILT, 3, HG_HITBOX_X, 54);
set_hitbox_value(AT_DTILT, 3, HG_HITBOX_Y, -6);
set_hitbox_value(AT_DTILT, 3, HG_WIDTH, 18);
set_hitbox_value(AT_DTILT, 3, HG_HEIGHT, 11);
set_hitbox_value(AT_DTILT, 3, HG_PRIORITY, 1);
set_hitbox_value(AT_DTILT, 3, HG_DAMAGE, 1);
set_hitbox_value(AT_DTILT, 3, HG_ANGLE, 1);
set_hitbox_value(AT_DTILT, 3, HG_BASE_KNOCKBACK, 1);
