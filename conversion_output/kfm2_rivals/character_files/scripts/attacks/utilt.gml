...
set_hitbox_value(AT_UTILT, 2, HG_WIDTH, -22);
set_hitbox_value(AT_UTILT, 2, HG_HEIGHT, 22);
set_hitbox_value(AT_UTILT, 2, HG_PRIORITY, 1);
set_hitbox_value(AT_UTILT, 2, HG_DAMAGE, 1);
set_hitbox_value(AT_UTILT, 2, HG_ANGLE, 1);
set_hitbox_value(AT_UTILT, 2, HG_BASE_KNOCKBACK, 1);
...
set_hitbox_value(AT_UTILT, 3, HG_WIDTH, 13);
set_hitbox_value(AT_UTILT, 3, HG_HEIGHT, 20);
set_hitbox_value(AT_UTILT, 3, HG_PRIORITY, 1);
set_hitbox_value(AT_UTILT, 3, HG_DAMAGE, 1);
set_hitbox_value(AT_UTILT, 3, HG_ANGLE, 1);
set_hitbox_value(AT_UTILT, 3, HG_BASE_KNOCKBACK, 1);
