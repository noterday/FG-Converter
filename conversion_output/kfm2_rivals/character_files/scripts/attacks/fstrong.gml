...
set_hitbox_value(AT_FSTRONG, 1, HG_HITBOX_Y, -73);
...
set_hitbox_value(AT_FSTRONG, 1, HG_ANGLE, 1);
...
set_hitbox_value(AT_FSTRONG, 2, HG_HITBOX_X, 72);
set_hitbox_value(AT_FSTRONG, 2, HG_HITBOX_Y, -72);
set_hitbox_value(AT_FSTRONG, 2, HG_WIDTH, 15);
set_hitbox_value(AT_FSTRONG, 2, HG_HEIGHT, -19);
set_hitbox_value(AT_FSTRONG, 2, HG_PRIORITY, 1);
set_hitbox_value(AT_FSTRONG, 2, HG_DAMAGE, 1);
set_hitbox_value(AT_FSTRONG, 2, HG_ANGLE, 1);
