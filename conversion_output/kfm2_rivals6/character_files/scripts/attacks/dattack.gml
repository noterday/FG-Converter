...
set_hitbox_value(AT_DATTACK, 1, HG_WIDTH, 63);
set_hitbox_value(AT_DATTACK, 1, HG_HEIGHT, 15);
set_hitbox_value(AT_DATTACK, 1, HG_PRIORITY, 1);
set_hitbox_value(AT_DATTACK, 1, HG_DAMAGE, 1);
set_hitbox_value(AT_DATTACK, 1, HG_ANGLE, 1);
...
set_hitbox_value(AT_DATTACK, 2, HG_HITBOX_Y, -58);
set_hitbox_value(AT_DATTACK, 2, HG_WIDTH, -62);
...
set_hitbox_value(AT_DATTACK, 2, HG_ANGLE, 1);
