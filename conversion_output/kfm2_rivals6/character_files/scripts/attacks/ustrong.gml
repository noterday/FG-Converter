...
set_hitbox_value(AT_USTRONG, 1, HG_WIDTH, 21);
...
set_hitbox_value(AT_USTRONG, 1, HG_ANGLE, 1);
...
set_hitbox_value(AT_USTRONG, 3, HG_HITBOX_X, 37);
set_hitbox_value(AT_USTRONG, 3, HG_HITBOX_Y, -112);
set_hitbox_value(AT_USTRONG, 3, HG_WIDTH, 14);
set_hitbox_value(AT_USTRONG, 3, HG_HEIGHT, -38);
set_hitbox_value(AT_USTRONG, 3, HG_PRIORITY, 1);
set_hitbox_value(AT_USTRONG, 3, HG_DAMAGE, 1);
set_hitbox_value(AT_USTRONG, 3, HG_ANGLE, 1);
